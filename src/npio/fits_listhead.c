...
int main(int argc, char *argv[])
{
    ...
    if (argc != 2) {
      printf("Usage:  fits_listhead filename[ext] \n");
      printf("\n");
      ...
      printf("\n");
      printf("Examples: \n");
      printf("   fits_listhead file.fits      - list every header in the file \n");
      printf("   fits_listhead file.fits[0]   - list primary array header \n");
      printf("   fits_listhead file.fits[2]   - list header of 2nd extension \n");
      printf("   fits_listhead file.fits+2    - same as above \n");
      printf("   fits_listhead file.fits[GTI] - list header of GTI extension\n");
      printf("\n");
